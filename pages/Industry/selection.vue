<template>
	<view class="container">
		...
		<view class="selection flex">
			<view class="selection-list flex_item">
				<view class="iconfont iconenter"></view>
				<view class="tip">销售<text>|</text>客服<text>|</text>市场<text>|</text>销售业务</view>
				<view class="iconfont iconenter"></view>
				<view class="tip">销售业务</view>
			</view>
			<view class="Return">返回上一级</view>
		</view>
		<view class="content">
...
.selection{
	padding: 25rpx 10rpx;
	font-size: 28rpx;
	border-bottom: 2rpx solid #A0E2E0;
	.selection-list{
		.iconfont{
			color: #5CCCC8;
		}
