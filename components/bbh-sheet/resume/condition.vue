		...
		@click="closeSheet()">
			<scroll-view scroll-y="true"  class="sheetView" :class="{sheetView_active:isShowBottom}"   @click.stop="stopEvent()" >
				<view class="box-content">
					<view class="box-top"><text class="text">工作状态</text></view>
					<view class="list">随时到岗</view>
					<view class="list">月内到岗</view>
					<view class="list">考虑机会</view>
					<view class="list">暂不考虑</view>
				</view>
			</scroll-view>
		</view>
	</view>
